...
export type Event = EventInstallationUpdated | EventInstallationUpdateAvailable | EventProjectUpdated | EventProjectRecentUpdated | EventServerInstanceDisposed | EventServerConnected | EventGlobalDisposed | EventLspClientDiagnostics | EventLspUpdated | EventMessagePartDelta | EventPermissionAsked | EventPermissionReplied | EventSessionStatus | EventSessionIdle | EventQuestionAsked | EventQuestionReplied | EventQuestionRejected | EventSessionCompacted | EventFileWatcherUpdated | EventFileEdited | EventTodoUpdated | EventTuiPromptAppend | EventTuiCommandExecute | EventTuiToastShow | EventTuiSessionSelect | EventMcpToolsChanged | EventMcpBrowserOpenFailed | EventCommandExecuted | EventSessionPreferenceUpdated | EventSessionDiff | EventSessionError | EventVcsBranchUpdated | EventWorkspaceReady | EventWorkspaceFailed | EventPtyCreated | EventPtyUpdated | EventPtyExited | EventPtyDeleted | EventWorktreeReady | EventWorktreeFailed | EventWechatStatus | EventWechatQrcode | EventWechatConnected | EventWechatError | EventFeishuStatus | EventFeishuConnected | EventFeishuError | EventFeishuReconnecting | EventMessageUpdated | EventMessageRemoved | EventMessagePartUpdated | EventMessagePartRemoved | EventSessionCreated | EventSessionUpdated | EventSessionDeleted;
...
export type DatabaseLegacyMergeStateResponse = DatabaseLegacyMergeStateResponses[keyof DatabaseLegacyMergeStateResponses];
...
export type DatabaseLegacyMergeStateResetResponse = DatabaseLegacyMergeStateResetResponses[keyof DatabaseLegacyMergeStateResetResponses];
...
export type FileTranslateMarkdownCheckResponse = FileTranslateMarkdownCheckResponses[keyof FileTranslateMarkdownCheckResponses];
...
export type FileTranslateMarkdownCancelResponse = FileTranslateMarkdownCancelResponses[keyof FileTranslateMarkdownCancelResponses];
...
export type ReadingModeSessionCreateResponse = ReadingModeSessionCreateResponses[keyof ReadingModeSessionCreateResponses];
...
export type ReadingModeSessionFromFileResponse = ReadingModeSessionFromFileResponses[keyof ReadingModeSessionFromFileResponses];
...
export type ReadingModeAnnotationsUpdateError = ReadingModeAnnotationsUpdateErrors[keyof ReadingModeAnnotationsUpdateErrors];
...
export type ReadingModeAnnotationsUpdateResponse = ReadingModeAnnotationsUpdateResponses[keyof ReadingModeAnnotationsUpdateResponses];
...
export type ReadingModeSessionUpdateResponse = ReadingModeSessionUpdateResponses[keyof ReadingModeSessionUpdateResponses];
