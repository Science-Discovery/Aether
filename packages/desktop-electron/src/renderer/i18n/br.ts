export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Aether",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Aether foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.cli.installed.message": "Aether CLI instalada.\n\nReinicie seu terminal para usar a Aether CLI.",
