export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Aether",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Aether er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message": "Aether CLI installeret.\n\nGenstart din terminal for at bruge Aether CLI.",
