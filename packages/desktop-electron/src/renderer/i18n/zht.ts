export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 Aether",
  ...
  "desktop.updater.downloaded.prompt": "已下載 Aether {{version}} 版本，是否安裝並重新啟動？",
  "desktop.updater.installFailed.title": "更新失敗",
  "desktop.updater.installFailed.message": "無法安裝更新",

  "desktop.cli.installed.title": "CLI 已安裝",
  "desktop.cli.installed.message": "Aether CLI 已安裝。\n\n重新啟動終端機以使用 Aether CLI。",
