export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Aether",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Aether wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "Aether CLI wurde installiert.\n\nStarten Sie Ihr Terminal neu, um die Aether CLI zu verwenden.",
