export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Aether",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Aether. ¿Quieres instalarla y reiniciar?",
