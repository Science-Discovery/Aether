export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Aether を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Aether のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "Aether CLI をインストールしました。\n\nターミナルを再起動して Aether CLI を使用してください。",
