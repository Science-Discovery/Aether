export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию Aether",
  ...
  "desktop.updater.downloaded.prompt": "Версия Aether {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message": "Aether CLI установлен.\n\nПерезапустите терминал, чтобы использовать Aether CLI.",
