export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Aether",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Aether، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.cli.installed.message": "تم تثبيت Aether CLI.\n\nأعد تشغيل الطرفية لاستخدام Aether CLI.",
