export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Aether",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Aether er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message": "Aether CLI installert.\n\nStart terminalen på nytt for å bruke Aether CLI.",
