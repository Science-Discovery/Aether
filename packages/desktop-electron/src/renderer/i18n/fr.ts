export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Aether",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Aether a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message": "Aether CLI installée.\n\nRedémarrez votre terminal pour utiliser la CLI Aether.",
