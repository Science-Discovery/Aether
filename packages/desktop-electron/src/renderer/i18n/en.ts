export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of Aether",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Aether has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "Aether CLI installed.\n\nRestart your terminal to use the Aether CLI.",
