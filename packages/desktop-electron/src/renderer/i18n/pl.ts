export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Aether",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Aether. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message": "Aether CLI zainstalowane.\n\nUruchom ponownie terminal, aby użyć Aether CLI.",
