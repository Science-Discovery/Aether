        ...
        <div class="flex-1 min-h-0 relative">
          <div class="size-full relative overflow-x-hidden">
            ...
            <div class="xl:hidden">
              <div
                classList={{
                  "fixed inset-x-0 top-7 bottom-0 z-40 transition-opacity duration-200": true,
              ...
              <nav
                ...
                classList={{
                  "@container fixed top-7 bottom-0 left-0 z-50 w-full max-w-[400px] overflow-hidden border-r border-border-weaker-base bg-background-base transition-transform duration-200 ease-out": true,
