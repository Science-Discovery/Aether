...
const ReadingSession: Component = () => {
  ...
  const variant = createMemo<LayoutVariant>(() => getReadingLayoutVariant(reviewOpen(), fileTreeOpen()))
  const mode = createMemo<ReadingLayoutMode>(() => getReadingLayoutMode(variant(), layoutSwapped()))
