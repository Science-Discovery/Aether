...
export const dict = {
  ...
  "command.sidebar.open": "사이드바 열기",
  "command.sidebar.close": "사이드바 닫기",
  ...
  "command.terminal.open": "터미널 열기",
  "command.terminal.close": "터미널 닫기",
  "command.fileTree.toggle": "파일 트리 토글",
  "command.fileTree.open": "파일 트리 열기",
  "command.fileTree.close": "파일 트리 닫기",
  "command.review.toggle": "검토 토글",
  "command.review.open": "검토 열기",
  "command.review.close": "검토 닫기",
  ...
  "dialog.model.unpaid.freeModels.title": "Aether에서 제공하는 무료 모델",
  ...
  "prompt.action.steer": "가이드",
  "prompt.steer.placeholder": "가이드 추가...",
  "prompt.steer.send": "보내기",
  "prompt.steer.toast.failed.title": "가이드 실패",
  "prompt.steer.toast.failed.description": "가이드 메시지 추가 실패",
  "prompt.steer.toast.notBusy.title": "세션 비활성",
  "prompt.steer.toast.notBusy.description": "가이드는 AI가 응답 중일 때만 사용 가능합니다",
  ...
  "dialog.directory.create.title": "폴더 만들기",
  "dialog.directory.create.message": "이 디렉터리가 존재하지 않습니다. 이 폴더를 만들까요?",
  "dialog.directory.create.action": "만들기",
  "dialog.server.title": "서버",
  "dialog.server.description": "이 앱이 연결할 Aether 서버를 전환합니다.",
  ...
  "error.page.report.prefix": "이 오류를 Aether 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: Aether는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "Aether에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "sidebar.project.errorSessions": "오류 세션 열기",
  "sidebar.project.errorSessionDeleted": "세션이 삭제되었습니다",
  "workspace.errorTooltip": "읽지 않은 오류 {{count}}개 · {{summary}}",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 Aether 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "Aether 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Aether가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Aether가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Aether 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Aether를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Aether를 사용 중입니다.",
  "font.option.system": "시스템 기본값",
  ...
  "workspace.delete.branch.title": "브랜치 삭제",
  "workspace.delete.branch.confirm": '브랜치 "{{branch}}"도 삭제하시겠습니까?',
  "workspace.delete.branch.keep": "브랜치 유지",
  "workspace.delete.branch.delete": "브랜치 삭제",
  ...
  "session.batch.delete.confirm": "{{count}}개의 세션을 삭제합니다. 이 작업은 되돌릴 수 없습니다.",
  "session.batch.selectedCount": "{{selected}} / {{total}}개 선택됨",
  "session.delete.math": "확인하려면 계산하세요: {{a}} + {{b}} = ?",
  "session.delete.math.wrong": "계산 결과가 올바르지 않습니다",
  "session.unarchiveAll": "전체 보관 취소",
  "session.unarchiveAll.done": "세션 {{count}}개의 보관을 취소했습니다",
  ...
  "dialog.project.delete.hasSessions": "{{name}}에 {{count}}개의 세션이 있습니다(최초 및 최근 세션):",
  ...
  "dialog.project.delete.failed": "프로젝트 삭제 실패",
