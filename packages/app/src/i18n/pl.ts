export const dict = {
  ...
  "command.sidebar.open": "Otwórz pasek boczny",
  "command.sidebar.close": "Zamknij pasek boczny",
  ...
  "command.terminal.open": "Otwórz terminal",
  "command.terminal.close": "Zamknij terminal",
  "command.fileTree.toggle": "Przełącz drzewo plików",
  "command.fileTree.open": "Otwórz drzewo plików",
  "command.fileTree.close": "Zamknij drzewo plików",
  "command.review.toggle": "Przełącz przegląd",
  "command.review.open": "Otwórz przegląd",
  "command.review.close": "Zamknij przegląd",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Aether",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Aether.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Aether.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Aether.",
  ...
  "dialog.directory.create.title": "Utwórz folder",
  "dialog.directory.create.message": "Ten katalog nie istnieje. Utworzyć ten folder?",
  "dialog.directory.create.action": "Utwórz",
  "dialog.server.title": "Serwery",
  "dialog.server.description": "Przełącz serwer Aether, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Aether ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Aether",
  ...
  "session.tab.moreFiles": "Więcej plików",
  ...
  "common.collapseAll": "Zwiń wszystkie",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "Aether zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "sidebar.project.errorSessions": "Otwórz sesje z błędami",
  "sidebar.project.errorSessionDeleted": "Sesja usunięta",
  "workspace.errorTooltip": "Nieprzeczytane błędy: {{count}} · {{summary}}",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Aether",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Aether na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Aether ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Aether.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Aether",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Aether.",
  "font.option.system": "Domyślny systemowy",
  ...
  "workspace.create.inProgress.title": "Tworzenie obszaru roboczego",
  "workspace.create.inProgress.description": "Poczekaj na zakończenie tworzenia bieżącego obszaru roboczego",
  ...
  "workspace.delete.branch.title": "Usuń gałąź",
  "workspace.delete.branch.confirm": 'Czy chcesz również usunąć gałąź "{{branch}}"?',
  "workspace.delete.branch.keep": "Zachowaj gałąź",
  "workspace.delete.branch.delete": "Usuń gałąź",
  ...
  "session.batch.delete.confirm": "Usunąć {{count}} sesji? Tej operacji nie można cofnąć.",
  "session.batch.selectedCount": "Wybrano {{selected}} / {{total}}",
  "session.delete.math": "Aby potwierdzić, oblicz: {{a}} + {{b}} = ?",
  "session.delete.math.wrong": "Nieprawidłowy wynik",
  "session.unarchiveAll": "Cofnij archiwizację wszystkich",
  "session.unarchiveAll.done": "Cofnięto archiwizację {{count}} sesji",
