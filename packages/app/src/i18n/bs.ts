export const dict = {
  ...
  "command.sidebar.open": "Otvori bočnu traku",
  "command.sidebar.close": "Zatvori bočnu traku",
  ...
  "command.terminal.open": "Otvori terminal",
  "command.terminal.close": "Zatvori terminal",
  "command.fileTree.toggle": "Prikaži/sakrij stablo datoteka",
  "command.fileTree.open": "Otvori stablo datoteka",
  "command.fileTree.close": "Zatvori stablo datoteka",
  "command.review.toggle": "Prikaži/sakrij pregled",
  "command.review.open": "Otvori pregled",
  "command.review.close": "Zatvori pregled",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Aether",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Aether-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Aether-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Aether-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Aether server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Aether-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Aether timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Aether još ne podržava MCP autentifikaciju.',
  ...
  "session.tab.moreFiles": "Više datoteka",
  ...
  "session.header.open.directory": "Otvori: {{name}}",
  ...
  "sidebar.gettingStarted.line1": "Aether uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Aether server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Aether-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Aether izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Aether prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Aether-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Aether pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Aether-a.",
  "font.option.system": "Zadani sistem",
  ...
  "workspace.delete.branch.title": "Izbriši granu",
  "workspace.delete.branch.confirm": 'Da li želite također izbrisati granu "{{branch}}"?',
  "workspace.delete.branch.keep": "Zadrži granu",
  "workspace.delete.branch.delete": "Izbriši granu",
  ...
  "session.batch.delete.confirm": "Izbrisati {{count}} sesija? Ovo se ne može poništiti.",
  "session.batch.selectedCount": "Odabrano {{selected}} / {{total}}",
  "session.delete.math": "Za potvrdu izračunaj: {{a}} + {{b}} = ?",
  "session.delete.math.wrong": "Netočan rezultat",
  "session.unarchiveAll": "Vrati sve iz arhive",
  "session.unarchiveAll.done": "Vraćeno {{count}} sesija iz arhive",
