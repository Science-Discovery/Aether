...
export const dict = {
  ...
  "toast.session.export.success.description": "已儲存到目前工作區根目錄：{{files}}",
  "toast.session.export.failed.title": "匯出工作階段失敗",
  "toast.session.import.success.title": "工作階段已匯入",
  "toast.session.import.success.description": "已開啟匯入後的工作階段「{{title}}」",
  ...
  "session.export.dialog.destination": "檔案會直接寫入目前工作區根目錄。",
  "session.export.mode.json": "僅 JSON",
  "session.export.mode.both": "JSON + Markdown",
  "session.export.option.thinking": "包含思考過程",
  "session.export.option.toolDetails": "包含工具詳情",
  "session.export.option.assistantMetadata": "包含助手中繼資料",
  ...
  "session.batch.archive": "封存 ({{count}})",
  "session.batch.delete": "刪除 ({{count}})",
  "session.batch.delete.confirm": "刪除 {{count}} 個工作階段？",
