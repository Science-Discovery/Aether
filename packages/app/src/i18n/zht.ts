...
export const dict = {
  ...
  "command.sidebar.open": "開啟側邊欄",
  "command.sidebar.close": "關閉側邊欄",
  ...
  "command.terminal.open": "開啟終端機",
  "command.terminal.close": "關閉終端機",
  "command.fileTree.toggle": "切換檔案樹",
  "command.fileTree.open": "開啟檔案樹",
  "command.fileTree.close": "關閉檔案樹",
  "command.review.toggle": "切換審查",
  "command.review.open": "開啟審查",
  "command.review.close": "關閉審查",
  ...
  "command.permissions.mode.off": "權限：全部確認",
  "command.permissions.mode.safe": "權限：安全區",
  "command.permissions.mode.full": "權限：全部自動接受",
  ...
  "prompt.permissions.safezone.title": "安全區",
  "prompt.permissions.safezone.description":
    "工作區外的檔案可以被讀取，私有區不會被讀取或寫入，工作區外的寫入仍會請求確認。開放區完全允許。",
  "prompt.permissions.safezone.private.label": "私有區（每行一個 glob）",
  "prompt.permissions.safezone.private.hint": "*.env",
  "prompt.permissions.safezone.open.label": "開放區（每行一個 glob）",
  "prompt.permissions.safezone.open.hint": "dist/**",
  "prompt.permissions.safezone.save": "儲存",
  "prompt.permissions.safezone.skip": "跳過",
  ...
  "toast.permissions.mode.safe.title": "安全區已啟用",
  "toast.permissions.mode.safe.description": "工作區外的檔案可以讀取，私有區受保護，其他操作仍會詢問",
  ...
  "session.header.open.directory": "開啟：{{name}}",
  ...
  "settings.general.defaultPermission.title": "預設權限模式",
  "settings.general.defaultPermission.description": "套用於新工作階段的權限級別",
  "settings.general.defaultPermission.option.off": "全部確認",
  "settings.general.defaultPermission.option.safe": "安全區",
  "settings.general.defaultPermission.option.full": "全部自動接受",
  ...
  "session.batch.delete.confirm": "將刪除 {{count}} 個工作階段，此操作無法復原。",
  "session.batch.selectedCount": "已選 {{selected}} / 共 {{total}}",
  "session.delete.math": "確認請計算：{{a}} + {{b}} = ?",
  "session.delete.math.wrong": "計算結果不正確",
  "session.unarchiveAll": "全部取消封存",
  "session.unarchiveAll.done": "已取消封存 {{count}} 個工作階段",
