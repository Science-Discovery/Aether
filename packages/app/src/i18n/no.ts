...
export const dict = {
  ...
  "command.sidebar.open": "Åpne sidepanel",
  "command.sidebar.close": "Lukk sidepanel",
  ...
  "command.terminal.open": "Åpne terminal",
  "command.terminal.close": "Lukk terminal",
  "command.fileTree.toggle": "Veksle filtre",
  "command.fileTree.open": "Åpne filtre",
  "command.fileTree.close": "Lukk filtre",
  "command.review.toggle": "Veksle gjennomgang",
  "command.review.open": "Åpne gjennomgang",
  "command.review.close": "Lukk gjennomgang",
  ...
  "command.permissions.mode.off": "Tillatelser: bekreft alle",
  "command.permissions.mode.safe": "Tillatelser: sikker sone",
  "command.permissions.mode.full": "Tillatelser: aksepter alle automatisk",
  ...
  "dialog.provider.maas.note": "Komplett modellutvalg",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Aether",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Aether.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Aether.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Aether.",
  ...
  "prompt.permissions.safezone.title": "Sikker sone",
  "prompt.permissions.safezone.description":
    "Filer utenfor arbeidsområdet kan leses, private soner blir aldri lest eller skrevet, og skriving utenfor arbeidsområdet krever fortsatt bekreftelse. Åpne soner er fullt tillatt.",
  "prompt.permissions.safezone.private.label": "Private soner (ett glob per linje)",
  "prompt.permissions.safezone.private.hint": "*.env",
  "prompt.permissions.safezone.open.label": "Åpne soner (ett glob per linje)",
  "prompt.permissions.safezone.open.hint": "dist/**",
  "prompt.permissions.safezone.save": "Lagre",
  "prompt.permissions.safezone.skip": "Hopp over",
  ...
  "dialog.server.description": "Bytt hvilken Aether-server denne appen kobler til.",
  ...
  "toast.permissions.mode.safe.title": "Sikker sone aktivert",
  "toast.permissions.mode.safe.description":
    "Filer utenfor arbeidsområdet kan leses, private soner er beskyttet, andre handlinger spør fortsatt",
  ...
  "toast.update.description": "En ny versjon av Aether ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Aether-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Aether ikke støtter MCP-autentisering ennå.',
  ...
  "session.tab.moreFiles": "Flere filer",
  ...
  "sidebar.gettingStarted.line1": "Aether inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "sidebar.project.errorSessions": "Åpne økter med feil",
  "sidebar.project.errorSessionDeleted": "Økt slettet",
  "workspace.errorTooltip": "{{count}} usette feil · {{summary}}",
  ...
  "settings.desktop.wsl.description": "Kjør Aether-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Aether",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Aether ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Aether skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Aether er tematisert.",
  ...
  "settings.general.defaultPermission.title": "Standard tillatelsesmodus",
  "settings.general.defaultPermission.description": "Tillatelsesnivå som brukes på nye økter",
  "settings.general.defaultPermission.option.off": "Bekreft alle",
  "settings.general.defaultPermission.option.safe": "Sikker sone",
  "settings.general.defaultPermission.option.full": "Aksepter alle automatisk",
  ...
  "settings.general.row.autoGitInit.description":
    "Initialiserer et Git-depot og aktiverer arbeidsområder for nye prosjekter",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Aether starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Aether.",
  ...
  "workspace.delete.branch.title": "Slett gren",
  "workspace.delete.branch.confirm": 'Vil du også slette grenen "{{branch}}"?',
  "workspace.delete.branch.keep": "Behold gren",
  "workspace.delete.branch.delete": "Slett gren",
  ...
  "session.batch.delete.confirm": "Slette {{count}} sesjoner? Dette kan ikke angres.",
  "session.batch.selectedCount": "{{selected}} / {{total}} valgt",
  "session.delete.math": "Beregn for å bekrefte: {{a}} + {{b}} = ?",
  "session.delete.math.wrong": "Feil resultat",
  "session.unarchiveAll": "Gjenopprett alle",
  "session.unarchiveAll.done": "Gjenopprettet {{count}} sesjoner",
