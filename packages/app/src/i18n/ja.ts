export const dict = {
  ...
  "command.sidebar.open": "サイドバーを開く",
  "command.sidebar.close": "サイドバーを閉じる",
  ...
  "command.terminal.open": "ターミナルを開く",
  "command.terminal.close": "ターミナルを閉じる",
  "command.fileTree.toggle": "ファイルツリーを切り替え",
  "command.fileTree.open": "ファイルツリーを開く",
  "command.fileTree.close": "ファイルツリーを閉じる",
  "command.review.toggle": "レビューの切り替え",
  "command.review.open": "レビューを開く",
  "command.review.close": "レビューを閉じる",
  ...
  "dialog.model.unpaid.freeModels.title": "Aetherが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Aetherで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してAetherで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Aetherで{{provider}}モデルを使用してください。",
  ...
  "prompt.action.steer": "ガイド",
  "prompt.steer.placeholder": "ガイドを追加...",
  "prompt.steer.send": "送信",
  "prompt.steer.toast.failed.title": "ガイド失敗",
  "prompt.steer.toast.failed.description": "ガイドメッセージの追加に失敗しました",
  "prompt.steer.toast.notBusy.title": "セッション非アクティブ",
  "prompt.steer.toast.notBusy.description": "ガイドはAIが応答中のみ使用可能です",
  ...
  "dialog.directory.create.title": "フォルダを作成",
  "dialog.directory.create.message": "このディレクトリは存在しません。このフォルダを作成しますか？",
  "dialog.directory.create.action": "作成",
  "dialog.server.title": "サーバー",
  "dialog.server.description": "このアプリが接続するAetherサーバーを切り替えます。",
  ...
  "error.page.report.prefix": "このエラーをAetherチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: AetherはまだMCP認証をサポートしていません。',
  ...
  "session.tab.moreFiles": "その他のファイル",
  ...
  "sidebar.gettingStarted.line1": "Aetherには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "sidebar.project.errorSessions": "エラーセッションを開く",
  "sidebar.project.errorSessionDeleted": "セッションは削除されました",
  "workspace.errorTooltip": "未読のエラー{{count}}件 · {{summary}}",
  ...
  "settings.general.row.language.description": "Aetherの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのAetherの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Aetherがシステム、ライト、またはダークテーマに従うかを選択します",
  ...
  "settings.updates.row.startup.description": "Aether の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Aether は最新バージョンです。",
  ...
  "workspace.delete.branch.title": "ブランチを削除",
  "workspace.delete.branch.confirm": 'ブランチ "{{branch}}" も削除しますか？',
  "workspace.delete.branch.keep": "ブランチを保持",
  "workspace.delete.branch.delete": "ブランチを削除",
  ...
  "session.batch.delete.confirm": "{{count}} 件のセッションを削除します。この操作は元に戻せません。",
  "session.batch.selectedCount": "{{selected}} / {{total}} 件を選択中",
  "session.delete.math": "確認するには計算してください：{{a}} + {{b}} = ?",
  "session.delete.math.wrong": "計算結果が正しくありません",
  "session.unarchiveAll": "すべてアーカイブ解除",
  "session.unarchiveAll.done": "{{count}} 件のセッションのアーカイブを解除しました",
