export const dict = {
  ...
  "settingsSkills.evolutionToggleDescription": "Trigger a background skill review after N steps where the AI made tool calls.",
  "settingsSkills.reviewInterval": "Review Interval",
  "settingsSkills.reviewIntervalDescription": "Number of tool-calling steps between automatic skill reviews.",
