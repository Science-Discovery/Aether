export const dict = {
  ...
  "settings.general.row.attachmentExtraction.description":
    "Convert unsupported PDF and image attachments with a user-managed MinerU service. Disabled by default.",
  ...
  "settings.general.row.mineruScope.all": "MinerU full extraction",
