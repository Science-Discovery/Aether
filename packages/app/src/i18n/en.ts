export const dict = {
  ...
  "toast.session.export.success.description": "Saved to workspace root: {{files}}",
  ...
  "session.export.dialog.destination": "Files will be written directly to the current workspace root.",
