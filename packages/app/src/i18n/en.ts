export const dict = {
  ...
  "settings.general.row.attachmentExtraction.title": "Attachment text extraction (experimental)",
  "settings.general.row.attachmentExtraction.description":
    "Convert unsupported PDF and image attachments with an Aether-guided or custom MinerU service. Disabled by default.",
  "settings.general.row.mineruMode.title": "Service mode",
  "settings.general.row.mineruMode.description": "Use an AI-guided local service or connect a custom deployment",
  "settings.general.row.mineruMode.managed": "Aether AI setup",
  "settings.general.row.mineruMode.external": "Custom service",
  "settings.general.row.mineruUrl.title": "MinerU service",
  "settings.general.row.mineruUrl.description": "The URL of your local or private mineru-api service",
  "settings.general.row.mineruUrl.test": "Save and test",
  "settings.general.row.mineruUrl.testing": "Testing...",
  "settings.general.row.mineruUrl.connected": "Connected",
  "settings.general.row.mineruUrl.failed": "Connection failed",
  "settings.general.row.mineruScope.title": "Processing mode",
  "settings.general.row.mineruScope.description": "Phase 1 processes every unsupported PDF and image with MinerU",
  "settings.general.row.mineruScope.unsupported": "Only attachments unsupported by the target model",
  "settings.general.mineru.unsupported": "AI-managed setup is available only on Windows x64 desktop",
  "settings.general.mineru.unconfigured": "Not configured",
  "settings.general.mineru.installing": "Configuring",
  "settings.general.mineru.ready": "Configured, not running",
  "settings.general.mineru.failed": "Setup failed; reopen the conversation to repair it",
  "settings.general.mineru.cancelled": "Setup paused; reopen the conversation to continue",
  "settings.general.mineru.running": "Running",
  "settings.general.mineru.configure": "Configure",
  "settings.general.mineru.more": "More MinerU actions",
  "settings.general.mineru.dialog.description":
    "Choose a service mode and manage the MinerU service used for attachment text extraction.",
  "settings.general.mineru.details.title": "Current configuration",
  "settings.general.mineru.details.scannedAt": "Measured:",
  "settings.general.mineru.details.measure": "Measure disk usage",
  "settings.general.mineru.details.measure.again": "Measure again",
  "settings.general.mineru.details.measure.running": "Measuring...",
  "settings.general.mineru.details.measure.done": "MinerU disk usage has been updated",
  "settings.general.mineru.details.runtime": "Runtime",
  "settings.general.mineru.details.runtime.managed": "Aether isolated environment",
  "settings.general.mineru.details.runtime.adopted": "Adopted environment",
  "settings.general.mineru.details.runtime.external": "User-managed service",
  "settings.general.mineru.details.address": "Service address",
  "settings.general.mineru.details.connection": "Connection status",
  "settings.general.mineru.details.directory": "Installation directory",
  "settings.general.mineru.details.dataDirectory": "Aether-managed data",
  "settings.general.mineru.details.backend": "Processing backend",
  "settings.general.mineru.details.source": "Model source",
  "settings.general.mineru.details.source.local": "Local model directory",
  "settings.general.mineru.details.device.auto": "Auto-selected device",
  "settings.general.mineru.details.size": "Disk usage",
  "settings.general.mineru.details.size.total": "Detected total",
  "settings.general.mineru.details.size.totalNote":
    "Sum of the virtual environment, model caches, and Aether-managed data",
  "settings.general.mineru.details.size.environment": "Virtual environment",
  "settings.general.mineru.details.size.models": "Model files and caches",
  "settings.general.mineru.details.size.modelsManaged": "MinerU model files and download caches managed by Aether",
  "settings.general.mineru.details.size.modelsShared":
    "Detected model files and shared caches that may also be used by other applications",
  "settings.general.mineru.details.size.aether": "Aether-managed data",
  "settings.general.mineru.details.modelDirectories": "Detected model and cache locations",
  "settings.general.mineru.details.managed": "Versions, files, and caches",
  "settings.general.mineru.details.userManaged": "Managed by the external environment",
  "settings.general.mineru.details.notDetected": "Not detected",
  "settings.general.mineru.details.unavailable": "Not available yet",
  "settings.general.mineru.details.calculating": "Calculated after setup",
  "settings.general.mineru.details.unmeasured": "Not measured yet",
  "settings.general.mineru.details.size.installation": "Includes the Aether-managed environment, dependencies, and model caches",
  "settings.general.mineru.details.size.aetherData":
    "Aether-managed data only; excludes the external environment and model caches",
  "settings.general.mineru.test": "Start test",
  "settings.general.mineru.testReady": "MinerU started and passed its health check",
  "settings.general.mineru.ai.title": "Configure MinerU with AI (experimental)",
  "settings.general.mineru.ai.description":
    "Create a setup conversation in this project so the selected model can inspect the environment and call constrained setup tools",
  "settings.general.mineru.ai.privacyTitle": "Setup conversation privacy",
  "settings.general.mineru.ai.privacy":
    "The selected provider may receive the OS and hardware summary, local paths, and necessary sanitized log excerpts. Full logs are not sent automatically.",
  "settings.general.mineru.ai.model": "Model used for setup",
  "settings.general.mineru.ai.toolHint":
    "Tool calling lets a model run Aether's constrained setup tools. It is separate from text, image, or PDF input support.",
  "settings.general.mineru.ai.noModel":
    "No tool-capable model is available. Configure one first or use a custom service.",
  "settings.general.mineru.ai.noProject": "Open a project before creating the MinerU setup conversation.",
  "settings.general.mineru.ai.confirmHint":
    "The model first performs a read-only inspection and shows the plan. Installation starts only after your confirmation.",
  "settings.general.mineru.ai.start": "Create setup conversation",
  "settings.general.mineru.ai.starting": "Creating...",
  "settings.general.mineru.ai.configure": "Configure MinerU",
  "settings.general.mineru.ai.reconfigure": "Repair or reconfigure",
  "settings.general.mineru.ai.open": "Open setup conversation",
  "settings.general.mineru.ai.sessionTitle": "Configure MinerU",
  "settings.general.mineru.ai.prompt":
    "Load $configure-mineru with the skill tool and follow it exactly. First call mineru_setup for a read-only inspection, then explain the environment, versions, directory, download size, and recommended plan. Do not install anything until I explicitly confirm.",
  "settings.general.mineru.externalHelp.open": "Custom setup guide",
  "settings.general.mineru.externalHelp.title": "Configure a custom MinerU service",
  "settings.general.mineru.externalHelp.description":
    "You can install a compatible MinerU 3.0 or later release, start its API, and connect Aether to it. Windows supports Python 3.10–3.12; the example uses the stable Python 3.12 option but does not pin a MinerU patch release.",
  "settings.general.mineru.externalHelp.check.title": "Check the Python version",
  "settings.general.mineru.externalHelp.check.description":
    "List the Python installations on this computer. Windows can use Python 3.10, 3.11, or 3.12; skip the next step if any one of them is already available.",
  "settings.general.mineru.externalHelp.python.title": "Install Python (only if missing)",
  "settings.general.mineru.externalHelp.python.description":
    "Install Python 3.12 with Windows Package Manager. Close and reopen PowerShell afterward so the py launcher can detect it. If winget is unavailable, install App Installer from Microsoft Store first.",
  "settings.general.mineru.externalHelp.env.title": "Create an isolated environment",
  "settings.general.mineru.externalHelp.env.description":
    "Create mineru-env in your user directory so MinerU and its dependencies do not affect system Python or other projects. The example uses 3.12; substitute 3.10 or 3.11 if that compatible version is already installed.",
  "settings.general.mineru.externalHelp.uv.title": "Prepare the installer",
  "settings.general.mineru.externalHelp.uv.description":
    "Update pip and install uv inside the new environment. uv installs MinerU dependencies faster and more reliably.",
  "settings.general.mineru.externalHelp.install.title": "Install MinerU",
  "settings.general.mineru.externalHelp.install.description":
    "Install the current dependency-compatible MinerU release with all components, without pinning a version. Aether requires the /health and asynchronous /tasks endpoints, so old MinerU 2.x releases are not compatible. This may take several minutes.",
  "settings.general.mineru.externalHelp.start.title": "Start the MinerU API service",
  "settings.general.mineru.externalHelp.start.description":
    "Use ModelScope as the model source and bind the service only to local port 8000. Keep this terminal open after the service address appears; models download on the first parse.",
  "settings.general.mineru.externalHelp.connect.title": "Connect Aether",
  "settings.general.mineru.externalHelp.connect.description":
    "Copy the address below, return to the custom service settings, paste it into the MinerU service field, then choose Save and test. Enable the feature after the health check succeeds.",
  "settings.general.mineru.externalHelp.note":
    "The service binds only to 127.0.0.1 and is not exposed to your LAN. Aether does not manage custom environments; keep the mineru-api terminal running while in use.",
  "settings.general.mineru.remove.open": "Uninstall completely",
  "settings.general.mineru.remove.title": "Uninstall MinerU",
  "settings.general.mineru.remove.loading": "Checking installed files…",
  "settings.general.mineru.remove.managed":
    "This stops MinerU and deletes the runtime, models, caches, and management data installed by Aether.",
  "settings.general.mineru.remove.adopted":
    "Aether is using an existing MinerU environment. By default, this only disconnects it and leaves external files intact.",
  "settings.general.mineru.remove.owned.managed": "Aether-managed MinerU installation",
  "settings.general.mineru.remove.owned.managedDescription":
    "Includes the isolated environment, model caches, setup state, logs, and temporary task data. The built-in $configure-mineru Skill is not included.",
  "settings.general.mineru.remove.owned.adopted": "MinerU connection data in Aether",
  "settings.general.mineru.remove.owned.adoptedDescription":
    "Includes only connection state, logs, and temporary task data. It does not include the $configure-mineru Skill or the adopted environment and models listed above.",
  "settings.general.mineru.remove.purge": "Also delete the adopted MinerU environment and dedicated model files",
  "settings.general.mineru.remove.purgeDescription":
    "Only the virtual environment, MinerU-specific model directories, and configuration listed below are deleted. Shared Hugging Face and ModelScope caches are preserved.",
  "settings.general.mineru.remove.warning":
    "The files below will be permanently deleted and cannot be recovered through Aether. Confirm that you no longer need this MinerU environment.",
  "settings.general.mineru.remove.environment": "Python virtual environment",
  "settings.general.mineru.remove.models": "MinerU-specific model directories",
  "settings.general.mineru.remove.config": "MinerU configuration file",
  "settings.general.mineru.remove.expected": "Estimated space reclaimed",
  "settings.general.mineru.remove.history": "Historical conversion results are preserved",
  "settings.general.mineru.remove.unknown": "Size unknown",
  "settings.general.mineru.remove.disconnect": "Disconnect only",
  "settings.general.mineru.remove.confirm": "Uninstall completely",
  "settings.general.mineru.remove.removing": "Uninstalling…",
  "settings.general.mineru.start.title": "Start MinerU?",
  "settings.general.mineru.start.description":
    "This model cannot read the attachment, so local MinerU needs to convert it to text first.",
  "settings.general.mineru.start.hint":
    "The service stays available for this Aether session. Aether asks again after restart.",
  "settings.general.mineru.start.decline": "Not now",
  "settings.general.mineru.start.confirm": "Start and continue",
  "settings.general.mineru.notification.interrupted": "MinerU setup was interrupted",
  "settings.general.mineru.notification.open": "Open settings or the original setup conversation to continue.",
  "settings.general.mineru.notification.ready": "MinerU setup complete",
  "settings.general.mineru.notification.readyDescription": "Attachment text extraction is ready to use.",
  "settings.general.mineru.notification.failed": "MinerU setup failed",
  "attachmentExtraction.result.title": "Attachment extraction result",
  "attachmentExtraction.result.completed": "Attachment text extraction complete",
  "attachmentExtraction.result.view": "View result",
  "attachmentExtraction.result.preview": "Preview",
  "attachmentExtraction.result.raw": "Raw text",
  "attachmentExtraction.result.copy": "Copy",
  "attachmentExtraction.result.copied": "Copied extraction result",
  "attachmentExtraction.result.download": "Download .md",
