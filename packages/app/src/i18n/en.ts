export const dict = {
  ...
  "settings.memory.description": "Manage durable memory behavior and inspect current memory stores.",
  "settings.memory.section.settings": "Settings",
  "settings.memory.section.stores": "Stores (read-only)",
  ...
  "settings.memory.row.crossSessionEnabled.description":
    "Allow the assistant to search past sessions for recall when needed.",
  "settings.memory.row.scope.title": "Default search scope",
  "settings.memory.row.scope.description": "Choose whether cross-session recall searches current project or all projects.",
  "settings.memory.row.reflection.title": "Enable memory reflection",
  "settings.memory.row.reflection.description": "Allow automatic memory consolidation after writes and at turn end.",
  "settings.memory.scope.currentProject": "Current project",
  "settings.memory.scope.global": "Global",
  "settings.memory.store.user": "USER store (global)",
  "settings.memory.store.memory": "MEMORY store (current project)",
