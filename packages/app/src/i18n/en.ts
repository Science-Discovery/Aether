export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OpenResearch",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenResearch.",
  ...
  "provider.connect.opencodeZen.visit.link": "openresearch.ai/zen",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenResearch.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenResearch.",
  ...
  "dialog.server.description": "Switch which OpenResearch server this app connects to.",
  ...
  "toast.update.description": "A new version of OpenResearch ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenResearch team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenResearch does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OpenResearch includes free models so you can start immediately.",
  "sidebar.gettingStarted.line2": "Connect any provider to use models, inc. Claude, GPT, Gemini etc.",
  "sidebar.project.recentSessions": "Recent sessions",
  "sidebar.project.viewAllSessions": "View all sessions",
  "sidebar.project.clearNotifications": "Clear notifications",

  "app.name.desktop": "OpenResearch Desktop",
  ...
  "settings.desktop.wsl.description": "Run the OpenResearch server inside WSL on Windows.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenResearch launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenResearch.",
