export const dict = {
  ...
  "command.sidebar.open": "فتح الشريط الجانبي",
  "command.sidebar.close": "إغلاق الشريط الجانبي",
  ...
  "command.terminal.open": "فتح المحطة الطرفية",
  "command.terminal.close": "إغلاق المحطة الطرفية",
  "command.fileTree.toggle": "تبديل شجرة الملفات",
  "command.fileTree.open": "فتح شجرة الملفات",
  "command.fileTree.close": "إغلاق شجرة الملفات",
  "command.review.toggle": "تبديل المراجعة",
  "command.review.open": "فتح المراجعة",
  "command.review.close": "إغلاق المراجعة",
  ...
  "command.permissions.mode.off": "الأذونات: تأكيد الكل",
  "command.permissions.mode.safe": "الأذونات: المنطقة الآمنة",
  "command.permissions.mode.full": "الأذونات: قبول الكل تلقائيًا",
  ...
  "dialog.provider.maas.note": "تشكيلة كاملة من النماذج",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Aether",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Aether.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Aether.",
  ...
  "prompt.permissions.safezone.title": "المنطقة الآمنة",
  "prompt.permissions.safezone.description":
    "يمكن قراءة الملفات خارج مساحة العمل، والمناطق الخاصة لا تُقرأ أو تُكتب أبدًا، والكتابة خارج مساحة العمل لا تزال تطلب التأكيد. المناطق المفتوحة مسموح بها بالكامل.",
  "prompt.permissions.safezone.private.label": "المناطق الخاصة (نمط واحد لكل سطر)",
  "prompt.permissions.safezone.private.hint": "*.env",
  "prompt.permissions.safezone.open.label": "المناطق المفتوحة (نمط واحد لكل سطر)",
  "prompt.permissions.safezone.open.hint": "dist/**",
  "prompt.permissions.safezone.save": "حفظ",
  "prompt.permissions.safezone.skip": "تخطي",
  ...
  "dialog.directory.create.title": "إنشاء مجلد",
  "dialog.directory.create.message": "هذا الدليل غير موجود. هل تريد إنشاء هذا المجلد؟",
  "dialog.directory.create.action": "إنشاء",
  "dialog.server.title": "الخوادم",
  "dialog.server.description": "تبديل خادم Aether الذي يتصل به هذا التطبيق.",
  ...
  "toast.permissions.mode.safe.title": "تم تمكين المنطقة الآمنة",
  "toast.permissions.mode.safe.description":
    "يمكن قراءة الملفات خارج مساحة العمل، والمناطق الخاصة محمية، وبقية الإجراءات تطلب التأكيد",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Aether",
  ...
  "session.tab.moreFiles": "المزيد من الملفات",
  ...
  "session.header.open.directory": "فتح: {{name}}",
  ...
  "sidebar.gettingStarted.line1": "يتضمن Aether نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "sidebar.project.errorSessions": "فتح الجلسات ذات الأخطاء",
  "sidebar.project.errorSessionDeleted": "تم حذف الجلسة",
  "workspace.errorTooltip": "{{count}} أخطاء غير مشاهدة · {{summary}}",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Aether داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Aether",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Aether على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Aether يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Aether.",
  ...
  "settings.general.defaultPermission.title": "وضع الأذونات الافتراضي",
  "settings.general.defaultPermission.description": "مستوى الأذونات المطبق على الجلسات الجديدة",
  "settings.general.defaultPermission.option.off": "تأكيد الكل",
  "settings.general.defaultPermission.option.safe": "المنطقة الآمنة",
  "settings.general.defaultPermission.option.full": "قبول الكل تلقائيًا",
  ...
  "settings.general.row.autoGitInit.title": "إنشاء مستودع Git تلقائيًا",
  "settings.general.row.autoGitInit.description": "تهيئة مستودع Git وتمكين مساحات العمل للمشاريع الجديدة",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Aether",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Aether.",
  "font.option.system": "افتراضي النظام",
  ...
  "workspace.delete.branch.title": "حذف الفرع",
  "workspace.delete.branch.confirm": 'هل تريد أيضاً حذف الفرع "{{branch}}"؟',
  "workspace.delete.branch.keep": "الاحتفاظ بالفرع",
  "workspace.delete.branch.delete": "حذف الفرع",
  ...
  "session.batch.delete.confirm": "حذف {{count}} جلسة؟ لا يمكن التراجع عن هذا الإجراء.",
  "session.batch.selectedCount": "تم تحديد {{selected}} / {{total}}",
  "session.delete.math": "للتأكيد، احسب: {{a}} + {{b}} = ؟",
  "session.delete.math.wrong": "النتيجة غير صحيحة",
  "session.unarchiveAll": "إلغاء أرشفة الكل",
  "session.unarchiveAll.done": "تم إلغاء أرشفة {{count}} جلسة",
