...
export const dict = {
  ...
  "dialog.provider.tag.educationResearchDiscount": "Rabatt für Bildung und Forschung",
  ...
  "dialog.server.group.ssh": "SSH-Remote",
  ...
  "session.tab.gitGraph.addTagMessageDescription": "?",  "session.tab.gitGraph.copiedHash": "?",
