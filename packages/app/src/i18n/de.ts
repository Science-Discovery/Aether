...
export const dict = {
  ...
  "command.sidebar.open": "Seitenleiste öffnen",
  "command.sidebar.close": "Seitenleiste schließen",
  ...
  "command.terminal.open": "Terminal öffnen",
  "command.terminal.close": "Terminal schließen",
  "command.fileTree.toggle": "Dateibaum umschalten",
  "command.fileTree.open": "Dateibaum öffnen",
  "command.fileTree.close": "Dateibaum schließen",
  "command.review.toggle": "Überprüfung umschalten",
  "command.review.open": "Überprüfung öffnen",
  "command.review.close": "Überprüfung schließen",
  ...
  "dialog.provider.maas.note": "Vollständige Modellauswahl",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Aether",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Aether zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Aether zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Aether zu nutzen.",
  ...
  "prompt.action.steer": "Lenken",
  "prompt.steer.placeholder": "Anleitung hinzufügen...",
  "prompt.steer.send": "Senden",
  "prompt.steer.toast.failed.title": "Lenken fehlgeschlagen",
  "prompt.steer.toast.failed.description": "Lenk-Nachricht konnte nicht hinzugefügt werden",
  "prompt.steer.toast.notBusy.title": "Sitzung nicht aktiv",
  "prompt.steer.toast.notBusy.description": "Lenken funktioniert nur, während die AI antwortet",
  ...
  "dialog.directory.create.title": "Ordner erstellen",
  "dialog.directory.create.message": "Dieses Verzeichnis existiert nicht. Diesen Ordner erstellen?",
  "dialog.directory.create.action": "Erstellen",
  "dialog.server.title": "Server",
  "dialog.server.description": "Wechseln Sie den Aether-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Aether ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Aether-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Aether unterstützt noch keine MCP-Authentifizierung.',
  ...
  "session.tab.moreFiles": "Weitere Dateien",
  ...
  "session.header.open.directory": "Öffnen: {{name}}",
  ...
  "sidebar.gettingStarted.line1": "Aether enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "sidebar.project.errorSessions": "Fehlersitzungen öffnen",
  "sidebar.project.errorSessionDeleted": "Sitzung gelöscht",
  "workspace.errorTooltip": "{{count}} ungesehene Fehler · {{summary}}",
  ...
  "settings.desktop.wsl.description": "Aether-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Aether ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Aether auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description": "Wählen Sie, ob Aether dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Aether anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Aether automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Aether.",
  ...
  "workspace.delete.branch.title": "Branch löschen",
  "workspace.delete.branch.confirm": 'Möchten Sie auch den Branch "{{branch}}" löschen?',
  "workspace.delete.branch.keep": "Branch behalten",
  "workspace.delete.branch.delete": "Branch löschen",
  ...
  "session.batch.delete.confirm": "{{count}} Sitzungen löschen? Dies kann nicht rückgängig gemacht werden.",
  "session.batch.selectedCount": "{{selected}} / {{total}} ausgewählt",
  "session.delete.math": "Zur Bestätigung lösen: {{a}} + {{b}} = ?",
  "session.delete.math.wrong": "Falsches Ergebnis",
  "session.unarchiveAll": "Alle wiederherstellen",
  "session.unarchiveAll.done": "{{count}} Sitzungen wiederhergestellt",
