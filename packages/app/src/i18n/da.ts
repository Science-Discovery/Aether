export const dict = {
  ...
  "command.sidebar.open": "Åbn sidebjælke",
  "command.sidebar.close": "Luk sidebjælke",
  ...
  "command.terminal.open": "Åbn terminal",
  "command.terminal.close": "Luk terminal",
  "command.fileTree.toggle": "Skift filtræ",
  "command.fileTree.open": "Åbn filtræ",
  "command.fileTree.close": "Luk filtræ",
  "command.review.toggle": "Skift gennemgang",
  "command.review.open": "Åbn gennemgang",
  "command.review.close": "Luk gennemgang",
  ...
  "dialog.provider.maas.note": "Komplet modeludvalg",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Aether",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Aether.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Aether.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Aether.",
  ...
  "dialog.directory.empty": "Ingen undermapper i denne mappe",
  "dialog.directory.existingProjects": "Eksisterende projekter",
  "dialog.directory.browse": "Gennemse",
  "dialog.directory.confirm": "Bekræft",
  "dialog.directory.create.title": "Opret mappe",
  "dialog.directory.create.message": "Denne mappe findes ikke. Vil du oprette den?",
  "dialog.directory.create.action": "Opret",

  "dialog.server.title": "Servere",
  "dialog.server.description": "Skift hvilken Aether-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Aether ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Aether-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Aether understøtter ikke MCP-godkendelse endnu.',
  ...
  "session.header.open.directory": "Åbn: {{name}}",
  ...
  "sidebar.gettingStarted.line1": "Aether inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Aether-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Aether",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Aether ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Aether følger systemets, lyst eller mørkt tema",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Aether starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Aether.",
  ...
  "workspace.create.inProgress.title": "Opretter arbejdsområde",
  "workspace.create.inProgress.description": "Vent til det aktuelle arbejdsområde er oprettet",
  ...
  "workspace.delete.branch.title": "Slet branch",
  "workspace.delete.branch.confirm": 'Vil du også slette branchen "{{branch}}"?',
  "workspace.delete.branch.keep": "Behold branch",
  "workspace.delete.branch.delete": "Slet branch",
  ...
  "session.batch.delete.confirm": "Slet {{count}} sessioner? Dette kan ikke fortrydes.",
  "session.batch.selectedCount": "{{selected}} / {{total}} valgt",
  "session.delete.math": "Beregn for at bekræfte: {{a}} + {{b}} = ?",
  "session.delete.math.wrong": "Forkert resultat",
  "session.unarchiveAll": "Gendan alle",
  "session.unarchiveAll.done": "Gendannede {{count}} sessioner",
