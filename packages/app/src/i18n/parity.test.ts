...
const keys = [
  ...
  "command.permissions.mode.off",
  "command.permissions.mode.safe",
  "command.permissions.mode.full",
  "prompt.permissions.safezone.title",
  "settings.general.defaultPermission.title",
