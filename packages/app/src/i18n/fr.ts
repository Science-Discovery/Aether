export const dict = {
  ...
  "command.sidebar.open": "Ouvrir la barre latérale",
  "command.sidebar.close": "Fermer la barre latérale",
  ...
  "command.terminal.open": "Ouvrir le terminal",
  "command.terminal.close": "Fermer le terminal",
  "command.fileTree.toggle": "Basculer l'arborescence des fichiers",
  "command.fileTree.open": "Ouvrir l'arborescence des fichiers",
  "command.fileTree.close": "Fermer l'arborescence des fichiers",
  "command.review.toggle": "Basculer la revue",
  "command.review.open": "Ouvrir la revue",
  "command.review.close": "Fermer la revue",
  ...
  "dialog.provider.maas.note": "Gamme complète de modèles",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Aether",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Aether.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Aether.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Aether.",
  ...
  "dialog.directory.empty": "Aucun sous-dossier dans ce répertoire",
  "dialog.directory.existingProjects": "Projets existants",
  "dialog.directory.browse": "Parcourir",
  "dialog.directory.confirm": "Confirmer",
  "dialog.directory.create.title": "Créer un dossier",
  "dialog.directory.create.message": "Ce répertoire n'existe pas. Créer ce dossier ?",
  "dialog.directory.create.action": "Créer",
  "dialog.server.title": "Serveurs",
  "dialog.server.description": "Changez le serveur Aether auquel cette application se connecte.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Aether",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Aether ne supporte pas encore l'authentification MCP.",
  ...
  "session.tab.moreFiles": "Plus de fichiers",
  ...
  "session.header.open.directory": "Ouvrir : {{name}}",
  ...
  "sidebar.project.errorSessions": "Ouvrir les sessions en erreur",
  "sidebar.project.errorSessionDeleted": "Session supprimée",
  "workspace.errorTooltip": "{{count}} erreurs non consultées · {{summary}}",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Aether dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Aether",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Aether sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Aether suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Aether.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Aether",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Aether.",
  "font.option.system": "Par défaut du système",
  ...
  "workspace.create.inProgress.title": "Création de l'espace de travail",
  "workspace.create.inProgress.description": "Veuillez attendre la fin de la création de l'espace de travail actuel",
  ...
  "workspace.delete.branch.title": "Supprimer la branche",
  "workspace.delete.branch.confirm": 'Voulez-vous également supprimer la branche "{{branch}}" ?',
  "workspace.delete.branch.keep": "Conserver la branche",
  "workspace.delete.branch.delete": "Supprimer la branche",
  ...
  "session.batch.delete.confirm": "Supprimer {{count}} sessions ? Cette action est irréversible.",
  "session.batch.selectedCount": "{{selected}} / {{total}} sélectionnées",
  "session.delete.math": "Pour confirmer, calculez : {{a}} + {{b}} = ?",
  "session.delete.math.wrong": "Résultat incorrect",
  "session.unarchiveAll": "Tout désarchiver",
  "session.unarchiveAll.done": "{{count}} sessions désarchivées",
