...
export const dict = {
  ...
  "fileTree.showInFolder": "在文件夹中打开",
  "fileTree.openedInFolder": "已在文件夹中打开",
  ...
  "session.batch.delete.confirm": "将删除 {{count}} 个会话，此操作不可恢复。",
  "session.batch.selectedCount": "已选 {{selected}} / 共 {{total}}",
  "session.delete.math": "确认请计算：{{a}} + {{b}} = ?",
  "session.delete.math.wrong": "计算结果不正确",
  "session.unarchiveAll": "全部取消归档",
  "session.unarchiveAll.done": "已取消归档 {{count}} 个会话",
  ...
  "workspace.create.inProgress.title": "正在创建工作区",
  "workspace.create.inProgress.description": "请等待当前工作区创建完成后再试",
  ...
  "workspace.delete.hasSessions": "检测到 {{count}} 个会话：合并后会转移到主工作区，不会丢失；直接删除则不可恢复。",
  "workspace.delete.mergeSessions": "合并会话到主工作区，并删除工作区",
  "workspace.delete.alsoDeleteSessions": "删除会话和工作区",
  ...
  "workspace.delete.unverified.confirm":
    '无法验证工作区 "{{name}}" 的 git 状态，其中可能存在未提交的更改。是否强制删除该目录？',
  ...
  "workspace.runEmpty": "未找到可执行脚本。在项目 .aether/.bin/ 或全局目录 {{path}} 中添加脚本后，右键此处可刷新",
  "workspace.runScript": "运行：{{name}}",
  "workspace.runGlobalScript": "全局：{{name}}",
  "workspace.ranScript": "已运行：{{name}}",
  "workspace.runFailed": "运行 {{name}} 失败：{{error}}",
