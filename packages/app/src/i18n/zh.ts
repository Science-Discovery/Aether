...
export const dict = {
  ...
  "app.server.sshReconnect.title": "正在重连远端主机 {{host}}",
  "app.server.sshReconnect.description": "检测到远端连接中断，正在尝试恢复会话。",
  "app.server.sshReconnect.success.title": "已恢复远端连接 {{host}}",
  "app.server.sshReconnect.success.description": "远端服务 {{version}} 已重新就绪。",
  "app.server.sshReconnect.retry.title": "远端连接异常，{{seconds}} 秒后重试",
  "app.server.sshReconnect.retry.description": "目标主机：{{host}}",
