...
export const dict = {
  ...
  "settings.general.row.voiceEnabled.title": "启用语音输入",
  "settings.general.row.voiceEnabled.description": "在工具栏中显示语音输入按钮",
  "settings.general.row.voiceEndpoint.title": "Qwen API 端点",
