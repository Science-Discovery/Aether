...
export const dict = {
  ...
  "settings.general.row.attachmentExtraction.title": "附件文字提取（测试）",
  "settings.general.row.attachmentExtraction.description":
    "配置额外的MinerU服务，将PDF和图片转换为文字——当模型不支持时",
  "settings.general.row.mineruMode.title": "服务方式",
  "settings.general.row.mineruMode.description": "使用 AI 引导配置的本地服务，或连接自行部署的服务",
  "settings.general.row.mineruMode.managed": "Aether AI 配置",
  "settings.general.row.mineruMode.external": "自定义服务",
  "settings.general.row.mineruUrl.title": "MinerU 服务",
  "settings.general.row.mineruUrl.description": "本机或内网 mineru-api 服务地址",
  "settings.general.row.mineruUrl.test": "保存并测试",
  "settings.general.row.mineruUrl.testing": "测试中...",
  "settings.general.row.mineruUrl.connected": "连接成功",
  "settings.general.row.mineruUrl.failed": "连接失败",
  "settings.general.row.mineruScope.title": "处理方式",
  "settings.general.row.mineruScope.description": "第一阶段会将所有不受目标模型支持的 PDF 和图片交给 MinerU",
  "settings.general.row.mineruScope.unsupported": "仅解析目标模型原生不支持的附件",
  "settings.general.mineru.unsupported": "仅 Windows x64 桌面端支持 AI 托管配置",
  "settings.general.mineru.unconfigured": "未配置",
  "settings.general.mineru.installing": "配置中",
  "settings.general.mineru.ready": "已配置，未运行",
  "settings.general.mineru.failed": "配置失败，可回到对话修复",
  "settings.general.mineru.cancelled": "配置已暂停，可回到对话继续",
  "settings.general.mineru.running": "运行中",
  "settings.general.mineru.configure": "配置",
  "settings.general.mineru.more": "更多 MinerU 操作",
  "settings.general.mineru.dialog.description": "选择服务方式并管理附件文字提取所使用的 MinerU 服务。",
  "settings.general.mineru.details.title": "当前配置",
  "settings.general.mineru.details.scannedAt": "统计时间：",
  "settings.general.mineru.details.measure": "统计空间占用",
  "settings.general.mineru.details.measure.again": "重新统计",
  "settings.general.mineru.details.measure.running": "统计中...",
  "settings.general.mineru.details.measure.done": "MinerU 空间占用统计已更新",
  "settings.general.mineru.details.runtime": "运行环境",
  "settings.general.mineru.details.runtime.managed": "Aether 隔离环境",
  "settings.general.mineru.details.runtime.adopted": "复用已有环境",
  "settings.general.mineru.details.runtime.external": "用户自定义服务",
  "settings.general.mineru.details.address": "服务地址",
  "settings.general.mineru.details.connection": "连接状态",
  "settings.general.mineru.details.directory": "安装位置",
  "settings.general.mineru.details.dataDirectory": "Aether 管理数据",
  "settings.general.mineru.details.backend": "处理后端",
  "settings.general.mineru.details.source": "模型源",
  "settings.general.mineru.details.source.local": "本地模型目录",
  "settings.general.mineru.details.device.auto": "自动选择设备",
  "settings.general.mineru.details.size": "空间占用",
  "settings.general.mineru.details.size.total": "检测到的总占用",
  "settings.general.mineru.details.size.totalNote": "虚拟环境、模型缓存与 Aether 管理数据之和",
  "settings.general.mineru.details.size.environment": "虚拟环境",
  "settings.general.mineru.details.size.models": "模型文件与缓存",
  "settings.general.mineru.details.size.modelsManaged": "Aether 托管的 MinerU 模型文件及下载缓存",
  "settings.general.mineru.details.size.modelsShared": "检测到的模型文件与共享缓存，可能也被其他程序使用",
  "settings.general.mineru.details.size.aether": "Aether 管理数据",
  "settings.general.mineru.details.modelDirectories": "检测到的模型与缓存位置",
  "settings.general.mineru.details.managed": "版本、文件与缓存",
  "settings.general.mineru.details.userManaged": "由外部环境管理",
  "settings.general.mineru.details.notDetected": "未检测到",
  "settings.general.mineru.details.unavailable": "尚不可用",
  "settings.general.mineru.details.calculating": "配置完成后统计",
  "settings.general.mineru.details.unmeasured": "尚未统计",
  "settings.general.mineru.details.size.installation": "包含 Aether 托管环境、依赖和模型缓存",
  "settings.general.mineru.details.size.aetherData": "仅 Aether 管理数据，不含外部环境和模型缓存",
  "settings.general.mineru.test": "启动测试",
  "settings.general.mineru.testReady": "MinerU 已启动并通过健康检查",
  "settings.general.mineru.ai.title": "使用 AI 配置 MinerU（测试版）",
  "settings.general.mineru.ai.description": "在当前项目创建配置对话，由所选模型分析环境并调用受限安装工具",
  "settings.general.mineru.ai.privacyTitle": "配置对话隐私说明",
  "settings.general.mineru.ai.privacy":
    "系统版本、硬件摘要、本地路径及必要的已脱敏日志可能发送给所选模型提供商。完整日志不会自动发送。",
  "settings.general.mineru.ai.model": "选择用于配置的模型",
  "settings.general.mineru.ai.toolHint":
    "工具调用表示模型可以让 Aether 执行安全的配置工具，与模型支持文本、图片或 PDF 的输入类型不同。",
  "settings.general.mineru.ai.noModel": "没有可用的工具调用模型，请先配置兼容模型或使用自定义服务。",
  "settings.general.mineru.ai.noProject": "请先打开一个项目，再创建 MinerU 配置对话。",
  "settings.general.mineru.ai.confirmHint": "模型会先只读检查并展示安装计划；得到你的确认后才会开始安装。",
  "settings.general.mineru.ai.start": "创建配置对话",
  "settings.general.mineru.ai.starting": "正在创建...",
  "settings.general.mineru.ai.configure": "配置 MinerU",
  "settings.general.mineru.ai.reconfigure": "修复或重新配置",
  "settings.general.mineru.ai.open": "查看配置对话",
  "settings.general.mineru.ai.sessionTitle": "配置 MinerU",
  "settings.general.mineru.ai.prompt":
    "请调用 skill 工具加载 $configure-mineru，并严格按照该 Skill 工作。先调用 mineru_setup 进行只读环境检查，向我说明检测结果、版本、目录、下载量和建议方案；在我明确确认前不要开始安装。",
  "settings.general.mineru.externalHelp.open": "自定义配置说明",
  "settings.general.mineru.externalHelp.title": "自定义 MinerU 服务配置",
  "settings.general.mineru.externalHelp.description":
    "你可以自行安装 MinerU 3.0 或更高的兼容版本并启动 API，再让 Aether 连接这个服务。Windows 可使用 Python 3.10–3.12；下方以兼容性稳定的 Python 3.12 为示例，并不要求固定的 MinerU 小版本。",
  "settings.general.mineru.externalHelp.check.title": "检查 Python 版本",
  "settings.general.mineru.externalHelp.check.description":
    "列出电脑中已安装的 Python。Windows 可使用 3.10、3.11 或 3.12；如果已有其中任一版本，可以跳过下一步。",
  "settings.general.mineru.externalHelp.python.title": "安装 Python（仅缺少时）",
  "settings.general.mineru.externalHelp.python.description":
    "使用 Windows 软件包管理器安装 Python 3.12。完成后请关闭并重新打开 PowerShell，让 py 命令识别新环境；如果 winget 不可用，请先从 Microsoft Store 安装“应用安装程序”。",
  "settings.general.mineru.externalHelp.env.title": "创建独立虚拟环境",
  "settings.general.mineru.externalHelp.env.description":
    "在用户目录创建 mineru-env，使 MinerU 及其依赖不影响系统 Python 或其他项目。示例使用 3.12；如果已有 3.10 或 3.11，可相应替换命令中的版本号。",
  "settings.general.mineru.externalHelp.uv.title": "准备安装工具",
  "settings.general.mineru.externalHelp.uv.description":
    "在刚创建的虚拟环境中更新 pip 并安装 uv；uv 用于更快、更稳定地安装 MinerU 依赖。",
  "settings.general.mineru.externalHelp.install.title": "安装 MinerU",
  "settings.general.mineru.externalHelp.install.description":
    "安装当前与依赖兼容的 MinerU 及完整组件，不锁定具体版本。Aether 需要服务支持 /health 和异步 /tasks 接口，因此不适用于旧版 MinerU 2.x。下载和安装可能需要几分钟。",
  "settings.general.mineru.externalHelp.start.title": "启动 MinerU API 服务",
  "settings.general.mineru.externalHelp.start.description":
    "使用 ModelScope 作为模型源，并让服务只监听本机 8000 端口。看到服务地址后请保持此终端开启；首次解析文件时还会下载模型。",
  "settings.general.mineru.externalHelp.connect.title": "连接到 Aether",
  "settings.general.mineru.externalHelp.connect.description":
    "复制下方地址，返回自定义服务设置并粘贴到“MinerU 服务”地址框，然后点击“保存并测试”。健康检查通过后即可启用。",
  "settings.general.mineru.externalHelp.note":
    "服务只绑定 127.0.0.1，不会向局域网开放。Aether 不会管理自定义环境；使用期间请保持 mineru-api 终端运行。",
  "settings.general.mineru.remove.open": "彻底卸载",
  "settings.general.mineru.remove.title": "卸载 MinerU",
  "settings.general.mineru.remove.loading": "正在检查安装内容……",
  "settings.general.mineru.remove.managed":
    "这会停止 MinerU，并删除由 Aether 安装的运行环境、模型、缓存和管理数据。",
  "settings.general.mineru.remove.adopted":
    "当前复用了已有 MinerU 环境。默认只解除它与 Aether 的连接，不会删除外部文件。",
  "settings.general.mineru.remove.owned.managed": "Aether 托管的 MinerU 安装",
  "settings.general.mineru.remove.owned.managedDescription":
    "包含隔离环境、模型缓存、安装状态、日志和临时任务数据；不包含内置 $configure-mineru Skill。",
  "settings.general.mineru.remove.owned.adopted": "Aether 中的 MinerU 连接数据",
  "settings.general.mineru.remove.owned.adoptedDescription":
    "仅包含连接状态、日志和临时任务数据；不包含 $configure-mineru Skill，也不包含上方复用的外部环境和模型。",
  "settings.general.mineru.remove.purge": "同时删除复用的 MinerU 环境和专属模型文件",
  "settings.general.mineru.remove.purgeDescription":
    "仅删除下方列出的虚拟环境、MinerU 专属模型目录和配置；不会删除整个 Hugging Face 或 ModelScope 共享缓存。",
  "settings.general.mineru.remove.warning": "以下文件将被永久删除，且无法通过 Aether 恢复。请确认其中没有你仍需使用的 MinerU 环境。",
  "settings.general.mineru.remove.environment": "Python 虚拟环境",
  "settings.general.mineru.remove.models": "MinerU 专属模型目录",
  "settings.general.mineru.remove.config": "MinerU 配置文件",
  "settings.general.mineru.remove.expected": "预计释放",
  "settings.general.mineru.remove.history": "历史转换结果不会删除",
  "settings.general.mineru.remove.unknown": "大小未知",
  "settings.general.mineru.remove.disconnect": "仅解除配置",
  "settings.general.mineru.remove.confirm": "彻底卸载",
  "settings.general.mineru.remove.removing": "正在卸载……",
  "settings.general.mineru.start.title": "启动 MinerU？",
  "settings.general.mineru.start.description": "当前模型无法读取此附件，需要先用本地 MinerU 转换为文字。",
  "settings.general.mineru.start.hint": "服务会在本次 Aether 运行期间保持，重启后将再次询问。",
  "settings.general.mineru.start.decline": "暂不启动",
  "settings.general.mineru.start.confirm": "启动并继续",
  "settings.general.mineru.notification.interrupted": "MinerU 配置已中断",
  "settings.general.mineru.notification.open": "打开设置或原配置对话即可继续。",
  "settings.general.mineru.notification.ready": "MinerU 配置完成",
  "settings.general.mineru.notification.readyDescription": "附件文字提取已可以使用。",
  "settings.general.mineru.notification.failed": "MinerU 配置失败",
  "attachmentExtraction.result.title": "附件转文字结果",
  "attachmentExtraction.result.completed": "附件转文字完成",
  "attachmentExtraction.result.view": "查看结果",
  "attachmentExtraction.result.preview": "预览",
  "attachmentExtraction.result.raw": "原始文本",
  "attachmentExtraction.result.copy": "复制",
  "attachmentExtraction.result.copied": "转换结果已复制",
  "attachmentExtraction.result.download": "下载 .md",
