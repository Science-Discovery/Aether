export const dict = {
  ...
  "command.sidebar.open": "เปิดแถบข้าง",
  "command.sidebar.close": "ปิดแถบข้าง",
  ...
  "command.terminal.open": "เปิดเทอร์มินัล",
  "command.terminal.close": "ปิดเทอร์มินัล",
  "command.fileTree.toggle": "สลับต้นไม้ไฟล์",
  "command.fileTree.open": "เปิดต้นไม้ไฟล์",
  "command.fileTree.close": "ปิดต้นไม้ไฟล์",
  "command.review.toggle": "สลับการตรวจสอบ",
  "command.review.open": "เปิดการตรวจสอบ",
  "command.review.close": "ปิดการตรวจสอบ",
  ...
  "dialog.provider.maas.note": "มีโมเดลครบทุกประเภท",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Aether",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Aether",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Aether",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน Aether",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ Aether ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ Aether ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม Aether",
  ...
  "error.chain.mcpFailed": 'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า Aether ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "session.tab.moreFiles": "ไฟล์เพิ่มเติม",
  ...
  "session.header.open.directory": "เปิด: {{name}}",
  ...
  "sidebar.gettingStarted.line1": "Aether รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "sidebar.project.errorSessions": "เปิดเซสชันที่มีข้อผิดพลาด",
  "sidebar.project.errorSessionDeleted": "ลบเซสชันแล้ว",
  "workspace.errorTooltip": "ข้อผิดพลาดที่ยังไม่ได้ดู {{count}} รายการ · {{summary}}",
  ...
  "settings.desktop.wsl.description": "เรียกใช้เซิร์ฟเวอร์ Aether ภายใน WSL บน Windows",
  ...
  "settings.general.row.language.description": "เปลี่ยนภาษาที่แสดงสำหรับ Aether",
  "settings.general.row.appearance.title": "รูปลักษณ์",
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ Aether มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ Aether ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ Aether มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ Aether เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน Aether เวอร์ชันล่าสุด",

  "font.option.system": "ค่าเริ่มต้นของระบบ",
  ...
  "workspace.delete.branch.title": "ลบสาขา",
  "workspace.delete.branch.confirm": 'คุณต้องการลบสาขา "{{branch}}" ด้วยหรือไม่?',
  "workspace.delete.branch.keep": "เก็บสาขาไว้",
  "workspace.delete.branch.delete": "ลบสาขา",
  ...
  "session.batch.delete.confirm": "ลบ {{count}} เซสชันหรือไม่ การดำเนินการนี้ย้อนกลับไม่ได้",
  "session.batch.selectedCount": "เลือก {{selected}} / {{total}} รายการ",
  "session.delete.math": "ยืนยันโดยคำนวณ: {{a}} + {{b}} = ?",
  "session.delete.math.wrong": "ผลลัพธ์ไม่ถูกต้อง",
  "session.unarchiveAll": "ยกเลิกการจัดเก็บทั้งหมด",
  "session.unarchiveAll.done": "ยกเลิกการจัดเก็บ {{count}} เซสชันแล้ว",
