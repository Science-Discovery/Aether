export const dict = {
  ...
  "provider.connect.opencodeZen.line1":
    "Aether Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.opencodeZen.visit.link": "aether.ai/zen",
