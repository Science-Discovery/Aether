export const dict = {
  ...
  "command.sidebar.open": "Открыть боковую панель",
  "command.sidebar.close": "Закрыть боковую панель",
  ...
  "command.terminal.open": "Открыть терминал",
  "command.terminal.close": "Закрыть терминал",
  "command.fileTree.toggle": "Переключить дерево файлов",
  "command.fileTree.open": "Открыть дерево файлов",
  "command.fileTree.close": "Закрыть дерево файлов",
  "command.review.toggle": "Переключить обзор",
  "command.review.open": "Открыть обзор",
  "command.review.close": "Закрыть обзор",
  ...
  "dialog.provider.maas.note": "Полная линейка моделей",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Aether",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Aether.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Aether.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Aether.",
  ...
  "dialog.server.description": "Переключите сервер Aether к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия Aether ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Aether",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Aether пока не поддерживает MCP авторизацию.',
  ...
  "session.header.open.directory": "Открыть: {{name}}",
  ...
  "sidebar.gettingStarted.line1": "Aether включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Aether внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Aether",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как Aether выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Aether системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Aether.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Aether",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Aether.",
  "font.option.system": "Системный по умолчанию",
  ...
  "workspace.delete.branch.title": "Удалить ветку",
  "workspace.delete.branch.confirm": 'Вы также хотите удалить ветку "{{branch}}"?',
  "workspace.delete.branch.keep": "Оставить ветку",
  "workspace.delete.branch.delete": "Удалить ветку",
  ...
  "session.batch.delete.confirm": "Удалить {{count}} сессий? Это действие необратимо.",
  "session.batch.selectedCount": "Выбрано {{selected}} / {{total}}",
  "session.delete.math": "Для подтверждения вычислите: {{a}} + {{b}} = ?",
  "session.delete.math.wrong": "Неверный результат",
  "session.unarchiveAll": "Разархивировать все",
  "session.unarchiveAll.done": "Разархивировано сессий: {{count}}",
