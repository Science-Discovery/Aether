export const dict = {
  ...
  "command.sidebar.open": "Abrir barra lateral",
  "command.sidebar.close": "Fechar barra lateral",
  ...
  "command.terminal.open": "Abrir terminal",
  "command.terminal.close": "Fechar terminal",
  "command.fileTree.toggle": "Alternar árvore de arquivos",
  "command.fileTree.open": "Abrir árvore de arquivos",
  "command.fileTree.close": "Fechar árvore de arquivos",
  "command.review.toggle": "Alternar revisão",
  "command.review.open": "Abrir revisão",
  "command.review.close": "Fechar revisão",
  ...
  "command.permissions.mode.off": "Permissões: confirmar todas",
  "command.permissions.mode.safe": "Permissões: zona segura",
  "command.permissions.mode.full": "Permissões: aceitar todas automaticamente",
  ...
  "dialog.provider.maas.note": "Linha completa de modelos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Aether",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Aether.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Aether.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Aether.",
  ...
  "prompt.action.steer": "Guiar",
  "prompt.steer.placeholder": "Adicionar guia...",
  "prompt.steer.send": "Enviar",
  "prompt.steer.toast.failed.title": "Guia falhou",
  "prompt.steer.toast.failed.description": "Falha ao adicionar mensagem guia",
  "prompt.steer.toast.notBusy.title": "Sessão inativa",
  "prompt.steer.toast.notBusy.description": "Guia funciona apenas enquanto a IA responde",
  ...
  "prompt.permissions.safezone.description":
    "Arquivos fora do espaço de trabalho podem ser lidos, zonas privadas nunca são lidas ou gravadas, e gravações fora do espaço de trabalho ainda pedem confirmação. Zonas abertas são totalmente permitidas.",
  "prompt.permissions.safezone.private.label": "Zonas privadas (um glob por linha)",
  "prompt.permissions.safezone.private.hint": "*.env",
  "prompt.permissions.safezone.open.label": "Zonas abertas (um glob por linha)",
  "prompt.permissions.safezone.open.hint": "dist/**",
  "prompt.permissions.safezone.save": "Salvar",
  "prompt.permissions.safezone.skip": "Pular",
  ...
  "dialog.directory.create.title": "Criar pasta",
  "dialog.directory.create.message": "Este diretorio nao existe. Criar esta pasta?",
  "dialog.directory.create.action": "Criar",
  "dialog.server.title": "Servidores",
  "dialog.server.description": "Trocar para qual servidor Aether este aplicativo se conecta.",
  ...
  "toast.permissions.mode.safe.title": "Zona segura ativada",
  "toast.permissions.mode.safe.description":
    "Arquivos fora do espaço de trabalho podem ser lidos, zonas privadas são protegidas, outras ações ainda pedem confirmação",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Aether",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Aether ainda não suporta autenticação MCP.',
  ...
  "session.tab.moreFiles": "Mais arquivos",
  ...
  "sidebar.gettingStarted.line1": "Aether inclui modelos gratuitos para você começar imediatamente.",
  ...
  "sidebar.project.errorSessions": "Abrir sessões com erro",
  "sidebar.project.errorSessionDeleted": "Sessão excluída",
  "workspace.errorTooltip": "{{count}} erros não vistos · {{summary}}",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Aether dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Aether",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Aether aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Aether segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Aether é tematizado.",
  ...
  "settings.general.defaultPermission.title": "Modo de permissão padrão",
  "settings.general.defaultPermission.description": "Nível de permissão aplicado a novas sessões",
  "settings.general.defaultPermission.option.off": "Confirmar todas",
  "settings.general.defaultPermission.option.safe": "Zona segura",
  "settings.general.defaultPermission.option.full": "Aceitar todas automaticamente",
  ...
  "settings.general.row.autoGitInit.description":
    "Inicializa um repositório Git e habilita espaços de trabalho em novos projetos",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Aether iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Aether.",
  "font.option.system": "Padrão do sistema",
  ...
  "workspace.delete.branch.title": "Excluir branch",
  "workspace.delete.branch.confirm": 'Deseja também excluir o branch "{{branch}}"?',
  "workspace.delete.branch.keep": "Manter branch",
  "workspace.delete.branch.delete": "Excluir branch",
  ...
  "session.batch.delete.confirm": "Excluir {{count}} sessões? Esta ação não pode ser desfeita.",
  "session.batch.selectedCount": "{{selected}} / {{total}} selecionadas",
  "session.delete.math": "Para confirmar, calcule: {{a}} + {{b}} = ?",
  "session.delete.math.wrong": "Resultado incorreto",
  "session.unarchiveAll": "Desarquivar todas",
  "session.unarchiveAll.done": "{{count}} sessões desarquivadas",
