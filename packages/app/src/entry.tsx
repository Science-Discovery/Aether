...
// The local backend always needs a heartbeat, and the currently selected remote
// backend too — otherwise its client lease expires while the app is connected to it.
const targets = () => {
