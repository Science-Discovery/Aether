    ...
    <div class="flex flex-col gap-3 w-full">
      ...
      >
        <div class="flex items-center gap-2">
          ...
          <span class="text-13-medium text-text-strong">{language.t("knowledgeBase.defaultSkills")}</span>
          <Show when={skills()}>
        ...
        <div class="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
          ...
          <Icon name={collapsed() ? "chevron-right" : "chevron-down"} size="small" class="text-icon-weak" />
        </div>
      </div>
      ...
      <Show when={!collapsed()}>
        ...
        <div
          ...
          title={language.t("defaultSkills.dragToResize")}
        >
