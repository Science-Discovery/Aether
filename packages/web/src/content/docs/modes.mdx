...
It comes with three built-in modes: **build**, **plan**, and **docs**. You can customize
...
opencode comes with three built-in modes.
...
Docs is designed for documentation work. It allows file operations for writing and updating docs, but disables shell commands by default.

This mode is useful when you want the AI to edit docs safely without running system commands.
