...
```
──────────────────────────────────────────────────────────────────────
优先级 1（最低）：保留配置来源中的 skills 目录
──────────────────────────────────────────────────────────────────────

扫描以下保留配置来源中的 skills/**/SKILL.md：

  Global.Path.config/skills/
  path.dirname(process.execPath)/.aether/skills/
  path.dirname(process.execPath)/.opencode/skills/
  OPENCODE_CONFIG_DIR/skills/（如果设置）

这一阶段不再扫描项目路径上的 .aether/skills 或 .opencode/skills，
避免重复加载项目外部目录阶段会处理的项目 skill。
单数 skill/ 目录不再兼容。
...
──────────────────────────────────────────────────────────────────────
优先级 3：AI 后台生成的 skill（项目级，优先级最低的项目来源）
──────────────────────────────────────────────────────────────────────
...
──────────────────────────────────────────────────────────────────────
优先级 4：项目外部目录（项目目录 → worktree 路径向上遍历）
──────────────────────────────────────────────────────────────────────
